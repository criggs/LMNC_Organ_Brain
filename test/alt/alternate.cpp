...
// //
// // This code can be tested using an online emulator with all the "Serial." lines uncommented.
...
//   MIDI.begin(MIDI_CHANNEL_OMNI); // TODO: disable for testing in WOKWI emulator
//   MIDI.turnThruOff();
